...
static const variant_info_t a53xnsxx = {
    ...
    .model = "SM-A536E",
    .name = "a53xnsxx",
    .build_fingerprint = "samsung/a53xnsxx/essi:15/AP3A.240905.015.A2/A536EXXSHFYI1:user/release-keys",
    .build_desc = "a53xnsxx-user 15 AP3A.240905.015.A2 A536EXXSHFYI1 release-keys"
};
